...
angular.module("airportApp")
    .controller("usersCtrl",function($scope,$http,$mdDialog,$mdToast,$animate){
        $scope.currentKaya = {};
        ...
        $http.get("process.php?page=fetch").success(function(data){
            $scope.users = data;
        });

        $scope.saveUser = function(user){
            $scope.currentSaving = true;
            $http.post("process.php?page=save", user).success(function (newUser) {
                $scope.users = newUser;
                $scope.currentKaya = {};
        ...
        $scope.updateUser = function(user){
            ...
            $http.post("process.php?page=update", user).success(function (newUser) {
        ...
        $scope.showConfirm = function(ev,id) {
            ...
            $mdDialog.show(confirm).then(function() {
                ...
                $http.post("process.php?page=delete",{id:id}).success(function (newVal) {
