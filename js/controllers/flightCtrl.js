...
angular.module("airportApp")
    .controller("flightCtrl",function($scope,$http,$mdDialog,$mdToast,$animate){
        $scope.currentKaya = {};
        ...
        $scope.saveUser = function(user){
            ...
            $http.post("flights.php?page=save", user).success(function (newUser) {
                $scope.users = newUser;
                $scope.currentKaya = {};
                $scope.currentSaving = false;
                $scope.kayaSavedFalue = false;
        ...
        $scope.updateUser = function(user){
            ...
            $http.post("flights.php?page=update", user).success(function (newUser) {
        ...
        $scope.showConfirm = function(ev,id) {
            ...
            $mdDialog.show(confirm).then(function() {
                ...
                $http.post("flights.php?page=delete",{id:id}).success(function (newVal) {
